...
<figure class="mechanism-video">
  <video controls muted playsinline preload="metadata" poster="/mechanisms/push-solver-scoring-board-only-poster.jpg" aria-label="Focused Zonoid transport demo board recording">
