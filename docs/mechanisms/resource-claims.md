...
<figure class="mechanism-video">
  <video controls muted playsinline preload="metadata" poster="/mechanisms/projectile-resource-use-board-only-poster.jpg" aria-label="Focused Zonoid resource claim demo board recording">
