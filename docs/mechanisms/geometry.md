...
<figure class="mechanism-video">
  <video controls muted playsinline preload="metadata" poster="/mechanisms/rays-chain-reactions-poster.jpg" aria-label="Focused Zonoid grid geometry demo board recording">
